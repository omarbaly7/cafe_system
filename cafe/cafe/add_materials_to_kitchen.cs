    ...
    public partial class add_materials_to_kitchen : Form
    {
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            if (name_textbox.Text != string.Empty && quantity_textbox.Text != string.Empty)
            {
                ...
                {
                    cn.Open();
                    cmd = new SqlCommand("insert into pinding_kitchen values('" + name_textbox.Text + "','" + quantity_textbox.Text + "','" + add_dateTimePicker.Value + "')", cn);
                    cmd.ExecuteNonQuery();
                    cn.Close();
